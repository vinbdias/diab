...
var PerguntasDataSource = function () {
    function PerguntasDataSource() {
        _classCallCheck(this, PerguntasDataSource);
    }

    _createClass(PerguntasDataSource, null, [{
        key: "getPerguntas",
        value: function getPerguntas() {
            ...
            return [{
                ...
                "opcoes": [{
                    ...
                    "id": "3",
                    "textoOpcao": "Faço as contas e pago até a data de vencimento.",
                    "valor": 7
                }, {

                    "id": "4",
                    "textoOpcao": "Pago imediatamente. Afinal, o dinheiro já estava reservado com antecedência. Eu sempre sei o valor que virá na minha fatura.",
                    "valor": 10
                }]
            }, {
                ...
                "opcoes": [{
                    ...
                    "id": "1",
                    "textoOpcao": "Pago todas as contas no dia em que recebo e uso o cartão de crédito no restante.",
                    "valor": 3
                }, {

                    "id": "2",
                    "textoOpcao": "Pago as contas e sobra um pouco para as despesas básicas. Gastos extras faço no cartão ou pego empréstimos.",
                    "valor": 5
                }, {
    ...
    return PerguntasDataSource;
}();
//# sourceMappingURL=PerguntasDataSource.js.map